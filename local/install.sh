...
# Wrangler/workerd lê variáveis de runtime do .dev.vars
...
[Unit]
Description=GetLicence App (TanStack via vite preview / workerd)
...
ExecStart=${BUN_BIN} x vite preview --host 127.0.0.1 --port 3000
Restart=always
RestartSec=3
User=${APP_USER}
[Install]
